...
{	
	...
	smokeDetonate( owner, statWeapon, smokeWeapon, position, SMOKE_GRENADE_RADIUS, totalTime, duration );
...
function spawnSmokeGrenadeTrigger( duration )
{
	...
	trigger = spawn( "trigger_radius", self.origin, 0, SMOKE_GRENADE_RADIUS, SMOKE_GRENADE_RADIUS );
	
	ARRAY_ADD( level.smoke_grenade_triggers, trigger );
